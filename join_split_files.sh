...
cat odm/lib64/libarcsoft_hdrgl_raw.so.* 2>/dev/null >> odm/lib64/libarcsoft_hdrgl_raw.so
rm -f odm/lib64/libarcsoft_hdrgl_raw.so.* 2>/dev/null
...
cat odm/lib64/libarcsoft_portrait_hdrgl_raw.so.* 2>/dev/null >> odm/lib64/libarcsoft_portrait_hdrgl_raw.so
rm -f odm/lib64/libarcsoft_portrait_hdrgl_raw.so.* 2>/dev/null
cat odm/lib64/libarcsoft_raw_glsr.so.* 2>/dev/null >> odm/lib64/libarcsoft_raw_glsr.so
rm -f odm/lib64/libarcsoft_raw_glsr.so.* 2>/dev/null
cat odm/lib64/libarcsoft_raw_sr.so.* 2>/dev/null >> odm/lib64/libarcsoft_raw_sr.so
rm -f odm/lib64/libarcsoft_raw_sr.so.* 2>/dev/null
cat odm/lib64/libremosaiclib_hp3.so.* 2>/dev/null >> odm/lib64/libremosaiclib_hp3.so
rm -f odm/lib64/libremosaiclib_hp3.so.* 2>/dev/null
